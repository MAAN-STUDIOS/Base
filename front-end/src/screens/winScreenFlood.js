...
<main class="${styles.main}" style="background: url('${floodWinBg}') center/cover no-repeat; min-height: 100vh;">
    ...
    <div class="${styles.container}">
        <h1" style="color: #39FF14; font-size: 3rem; margin-bottom: 20px; text-shadow: 2px 2px 12px #000, 0 0 20px #39FF14;">FLOOD VICTORY</h1>
        ...
        <button class="${styles.startButton}" id="btn-menuu" style="margin-bottom: 18px; font-size: 1.2rem; padding: 18px 38px; border-radius: 40px; background: linear-gradient(90deg,rgb(0, 193, 45) 60%,rgb(0, 201, 54) 100%); box-shadow: 0 0 18pxrgb(63, 155, 26);">Return to Main Menu</button>
